...
namespace OpusDotNet {
    ...
    public class OpusEncoder : IDisposable {
        ...
        /// <summary>
        /// Initializes a new <see cref="OpusEncoder" /> instance, with the specified intended
        /// application, 48000 Hz sample rate and 2 channels.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="OpusEncoder" /> instance, with the specified intended
        /// application, sample rate and channels.
        /// </summary>
        /// <param name="application"> The intended application. </param>
        /// <param name="sampleRate"> 
        /// The sample rate in the input audio, 48000, 24000, 16000, 12000 or 8000 Hz.
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the computational complexity, 0 - 10. Decreasing this will decrease CPU
        ...
        /// <summary>
        /// Gets or sets whether to use DTX (discontinuous transmission). When enabled the encoder
        /// will produce packets with a length of 2 bytes or less during periods of no voice activity.
        /// </summary>
        public bool DTX {
            get {
                ThrowIfDisposed( );
        ...
        /// <summary>
        /// Gets or sets the expected packet loss percentage when using FEC (forward error
        /// correction). Increasing this will improve quality under loss, at the expense of quality
        ...
        /// <summary>
        /// Gets or sets whether to use FEC (forward error correction). You need to adjust
        /// <see cref="ExpectedPacketLoss" /> before FEC takes effect.
        /// </summary>
        public bool FEC {
            get {
                ThrowIfDisposed( );
        ...
        /// <summary>
        /// Encodes an Opus frame, the frame size must be one of the following: 2.5, 5, 10, 20, 40
        /// or 60 ms.
        /// </summary>
        ...
        /// <param name="opusLength">
        /// The maximum number of bytes to write to <paramref name="opusBytes" />. This will
        /// determine the bitrate in the encoded audio.
        /// </param>
