...
namespace OpusDotNet {
    ...
    public class OpusDecoder : IDisposable {
        ...
        /// <summary>
        /// Initializes a new <see cref="OpusDecoder" /> instance, with the specified sample rate
        /// and channels.
        /// </summary>
        /// <param name="sampleRate">
        /// The sample rate to decode to, 48000, 24000, 16000, 12000 or 8000 Hz.
        /// </param>
        ...
        /// The maximum number of bytes to read from <paramref name="opusBytes" />, or -1 to
        /// indicate packet loss.
        /// </param>
        /// <param name="pcmBytes">   The buffer that the decoded audio will be stored in. </param>
        /// <param name="pcmLength"> 
        /// The maximum number of bytes to write to <paramref name="pcmBytes" />. When using FEC
        /// (forward error correction) this must be a valid frame size that matches the duration of
        /// the missing audio.
        /// </param>
